  ...
  <section class="capabilities container" id="services">
    ...
    <div class="capabilities__grid">
      <a href="services/web.php" class="cap reveal" data-spotlight>
        <span class="cap__icon" aria-hidden="true">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">
            ...
            <circle cx="7.6" cy="6" r="0.7" fill="currentColor" />
            <path d="M9 21h6" />
            <path d="M12 17.5V21" />
          </svg>
        </span>
      ...
      <a href="services/ai.php" class="cap reveal" data-spotlight>
        <span class="cap__icon" aria-hidden="true">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">
            <path d="M12 3l1.6 4.2L18 8.8l-3.4 2.7L15.4 16 12 13.7 8.6 16l.8-4.5L6 8.8l4.4-1.6L12 3z" />
            <path d="M19 14.5l.6 1.7 1.7.6-1.7.6L19 19l-.6-1.6-1.7-.6 1.7-.6.6-1.7z" />
            <path d="M5 16l.4 1.2 1.2.4-1.2.4L5 19.2l-.4-1.2-1.2-.4 1.2-.4.4-1.2z" />
          </svg>
        </span>
      ...
      <a href="services/bespoke.php" class="cap reveal" data-spotlight>
        <span class="cap__icon" aria-hidden="true">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">
            <path d="M14.5 4.5a4 4 0 0 0-5.4 5.2L4 14.9a1.7 1.7 0 1 0 2.4 2.4l5.3-5.2a4 4 0 0 0 5.2-5.4l-2.6 2.6-2-2 2.2-2.8z" />
          </svg>
        </span>
